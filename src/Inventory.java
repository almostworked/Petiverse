 ...
 * which can add, remove and update items in invetory
 */
public class Inventory {
	...
	/**
         ...
         * @param hasGifts A boolean indicated if the inventory contains gifts
         */
	public Inventory(List<Item> items, boolean hasGifts) {
        ...
        /**
         * This retrives the quantity of an item in the inventory
	...
	public void displayMethods() {
         ...
         * If it exits, it will be increased else it will be created
